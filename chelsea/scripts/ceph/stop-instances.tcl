...
puts "This script will stop the following instances: [join $instanceNames {, }]"
...
proc stopInstances {instanceIds} {
    if {[llength $instanceIds] == 0} {
        puts "No instances to stop!"
        return
    }
    puts -nonewline "Stopping... "
    exec aws ec2 stop-instances --instance-ids {*}$instanceIds
    puts "Done!"
}
