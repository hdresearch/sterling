...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("sterling", .{
    ...
    // Parser tests (tests/parser/openapi_test.zig)
    const parser_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("tests/parser/openapi_test.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
    ...
    // Config tests (tests/config/config_test.zig)
    const config_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("tests/config/config_test.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
    ...
    // Docs generator tests (tests/docs/generator_test.zig)
    const docs_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("tests/docs/generator_test.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "docs_gen", .module = b.createModule(.{
                    .root_source_file = b.path("src/docs/generator.zig"),
                    .target = target,
                }) },
            },
        }),
